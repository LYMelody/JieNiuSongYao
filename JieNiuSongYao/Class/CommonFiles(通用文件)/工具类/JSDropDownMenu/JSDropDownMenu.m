...
- (void)setDataSource:(id<JSDropDownMenuDataSource>)dataSource {
    ...
    for (int i = 0; i < _numOfMenu; i++) {
        ...
        if (i == 0) {
            title.foregroundColor = [UIColor orangeColor].CGColor;
        }
        ...
        if (i == 0) {
            title.foregroundColor = ColorTabBarback.CGColor;
            indicator.fillColor = ColorTabBarback.CGColor;
        }
        ...
        if (i != tapIndex) {
            [self animateIndicator:_indicators[i] Forward:NO complete:^{
                [self animateTitle:_titles[i] show:NO complete:^{
                    ...
                    CAShapeLayer *shapLayer = _indicators[i];
                    title.foregroundColor = [UIColor grayColor].CGColor;
                    shapLayer.fillColor = [UIColor grayColor].CGColor;
                }];
            }];
            ...
            CAShapeLayer *shapLayer = _indicators[i];
            title.foregroundColor = ColorTabBarback.CGColor;
            shapLayer.fillColor = ColorTabBarback.CGColor;
        }
