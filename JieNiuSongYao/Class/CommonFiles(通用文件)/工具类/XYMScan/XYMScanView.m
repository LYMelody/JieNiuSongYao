...
@interface XYMScanView ()<AVCaptureMetadataOutputObjectsDelegate,CAAnimationDelegate>
{
...
- (void)setOverlayPickerView
{
    ...
    //tiplab.frame = CGRectMake(40, 50, 200, 40);
    tiplab.text = @"将取景框对准条形码即\n可自动扫描";
    tiplab.font = [UIFont systemFontOfSize:15];
    tiplab.backgroundColor = [UIColor redColor];
    tiplab.textAlignment = NSTextAlignmentCenter;
    tiplab.alpha = 1;
    tiplab.numberOfLines = 0;
    tiplab.layer.borderWidth = 0;
    tiplab.textColor = [UIColor whiteColor];
    _TipsLab = tiplab;
    [_downView addSubview:_TipsLab];
...
- (void)layoutSubviews{
    ...
    _TipsLab.frame = CGRectMake(x + 30 , y + 20, width - 1, 60);
