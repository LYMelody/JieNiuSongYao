...
-(void)chushihua{
    ...
    _array1 = [NSArray arrayWithObjects:(id)[[UIColor colorWithHex:0xabfd49] CGColor],(id)[[UIColor colorWithHex:0xabfd49] CGColor],(id)[[UIColor colorWithHex:0xabfd49] CGColor], nil];
