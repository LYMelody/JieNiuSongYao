...
-(void)createScrollView{
    ...
    for (int i=0; i<imageCount; i++) {
        ...
        UILabel *showTitleLabel=[[UILabel alloc]initWithFrame:CGRectMake(0, screenHeightH*0.7, screenWidthW, showTitleLabelH)];  //在图片上面添加UILabel
        ...
        showTitleLabel.font=[UIFont systemFontOfSize:18];
...
-(void)addStartButton:(UIImageView *)imageView{
    ...
    [button setBackgroundColor:ColorTabBarback];
    
    button.frame=CGRectMake(screenWidthW/2-startButtonW/2, screenHeightH*0.87, startButtonW, startButtonH);
...
-(void)startApp{
    ...
    windows.rootViewController=MainBarVc;
